          ...
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              ...
              <div className="d-flex">
                ...
                >
                  <i className="ri-add-line fw-semibold align-middle me-1"></i>{" "}
                  Create Task
                </Button>
                ...
                <Dropdown className="dropdown ms-2">
                  <Dropdown.Toggle
                    ...
                    className="btn btn-icon  btn-sm btn-wave waves-light no-caret"
                    type="button"
                  >
                ...
                <Table className="table text-nowrap table-bordered">
                  ...
                  <tbody>
                    <tr className="task-list">
                      ...
                      <td>10-06-2023</td>
                      <td>
                        <Badge bg="secondary-transparent" className="badge">
                          Medium
                        </Badge>
                      </td>
                      <td>
                      ...
                      <td>
                        ...
                        <Button
                          ...
                          className="btn btn-icon ms-1 btn-sm task-delete-btn"
                        >
                    ...
                    <tr className="task-list">
                      ...
                      <td>16-06-2023</td>
                      <td>
                        <Badge bg="success-transparent" className="badge">
                          Low
                        </Badge>
                      </td>
                      <td>
                    ...
                    <tr className="task-list">
                      ...
                      <td>25-06-2023</td>
                      <td>
                        <Badge bg="danger-transparent" className="badge">
                          High
                        </Badge>
                      </td>
                      <td>
                  ...
                  <div className="pb-0 mt-0">
                    <div>
                      <h4 className="fs-18 fw-semibold mb-2">
                        ...
                        <span className="text-muted float-end fs-11 fw-normal">
                          Last Year
                        </span>
                      </h4>
              ...
              <div className="p-4 border-bottom border-block-end-dashed d-flex align-items-top">
                ...
                <div className="flex-fill">
                  <h6 className="mb-2 fs-12">
                    ...
                    <Badge
                      bg="success"
                      className="badge  fw-semibold float-end"
                    >
                      4,176
                    </Badge>
                  </h6>
